...
function deleteMailForPw(){
	if(document.getElementById('memidmail').value!=''){
	document.getElementById('mempwmail').value='';
	$("form").submit();}}
function deleteMailForId(){
	if(document.getElementById('mempwmail').value!=null){
