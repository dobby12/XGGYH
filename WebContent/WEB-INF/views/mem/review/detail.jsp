...
<tr>
<td class="info">제목</td><td colspan="8">${viewReview.reviewTitle }</td>
</tr>
<tr>
<td class="info">닉네임</td><td colspan="8">${memNick }</td>
</tr>
<tr>
<td class="info">작성일</td><td>${viewReview.reviewDate }</td>
<td class="info">조회수</td><td>${viewReview.reviewHit }</td>
</tr>
<tr>
<td class="info">공연 제목</td><td>${showTitle }</td>
<td class="info">별점</td><td>${viewReview.reviewScore }</td>
</tr>
<tr><td class="info" colspan="8">본문</td></tr>
<tr><td  colspan="12">${viewReview.reviewContent }</td></tr>
