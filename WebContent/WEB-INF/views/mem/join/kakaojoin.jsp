...
<form action="<%=request.getContextPath() %>/kakaojoin" method="post" onsubmit="return checked()" class="form-horizontal">
	...
	<div class="form-group">
 	...
 	<div class="form-group">
		...
		<input type="text" id="memmail" name="memmail" class="form-control" value="${kakaojoin }" readonly="readonly"/>
	</div>
	<div class="form-group">
