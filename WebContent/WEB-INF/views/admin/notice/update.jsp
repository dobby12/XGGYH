...
<tr>
	<td colspan="6" style="font-size: 30px; width: 100%; padding: 5px; height: 50px;"><input type="text" id="title" name="title" style="width: 100%; padding: 5px;" value="${notice.noticeTitle }"/></td>
</tr>
<tr>
